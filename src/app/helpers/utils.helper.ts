export class UtilsHelper {
    ...
    public static distance = (lat1: number, lng1: number, lat2: number, lng2: number) => {
        ...
        return 111.045
            * degrees(Math.acos(Math.min(1.0, Math.cos(radians(lat1))
            * Math.cos(radians(lat2))
            * Math.cos(radians(lng1) - radians(lng2))
